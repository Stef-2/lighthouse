...
export namespace lh
{
	...
	public:
		...
		static auto up_direction() -> const geometry::normal_t&
		{
		...
		auto view_direction() const -> const geometry::normal_t
		{
		...
		auto right_direction() const -> const geometry::normal_t
		{
	...
	private:
		static inline const auto s_up_direction = geometry::normal_t {0.0f, 1.0f, 0.0f};
